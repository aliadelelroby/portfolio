         ...
         <div className="row">
            ...
            >
               ...
               <p className="mt-2 mt-md-4">
                  A passionate web developer, always following best practices.
                  <br /> I care that the customer is satisfied with my work.
               </p>
...
export const Features = () => {
   ...
   return (
      <section>
         <div className="row">
            <h2 className="main-title">You Will Get</h2>
         </div>
